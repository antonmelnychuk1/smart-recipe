...
const baseHomeCopy = {
  ...
  uk: {
    nav: {
      ...
      history: "Історія",
      recipeHistory: "Історія рецептів",
      admin: "Адмін",
      accountSettings: "Налаштування акаунта",
      adminPanel: "Панель адміністратора",
      logout: "Вийти",
      logoutFull: "Вийти з акаунта",
      login: "Увійти",
      loginOrCreate: "Увійти або створити акаунт",
      openMenu: "Відкрити меню",
      closeMenu: "Закрити меню",
      language: "Мова",
    },
    hero: {
      badge: "Менше відходів, більше смаку",
      title: "Що сьогодні приготуємо",
      titleAccent: "з того, що маєш?",
      description:
        "Введи продукти зі своєї кухні. Ми знайдемо для них смачне застосування і підкажемо, чого може бракувати.",
    },
    generator: {
      ingredientsLabel: "Твої інгредієнти",
      addProduct: "Додай продукт...",
      suggestions: "Підказки:",
      diet: "Дієта",
      budget: "Бюджет на 2 порції",
      maxTime: "Максимальний час",
      generating: "AI готує...",
      generate: "Згенерувати рецепти",
      adminLimit: "Акаунт адміністратора — генерація без ліміту.",
      accountLimitPrefix: "Твій акаунт має",
      accountLimitSuffix: "генерацій на день",
      guestLimitPrefix: "Без акаунта доступно",
      guestLimitSuffix: "генерації на день",
      createAccount: "Створи акаунт — збільш ліміт до 20",
      loadingTitle: "AI готує пропозиції...",
      loadingText:
        "Створюємо 3 рецепти з пропорціями, харчовою цінністю та фото з Pexels.",
      remainingToday: "Залишилось сьогодні:",
      generations: "генерацій",
      resetAt: "Ліміт оновиться",
      fallbackError: "Не вдалося згенерувати рецепти.",
      removeIngredient: "Видалити",
    },
    how: [
      ["01", "Додай інгредієнти", "Введи те, що маєш у холодильнику та коморі."],
    ...
    dish: {
      ...
      description:
        "Напиши «pancakes», «гуляш» або точніше: «веганське карі з нутом». Отримаєш повний рецепт для двох людей.",
      label: "Назва або опис страви",
      placeholder: "наприклад, пухкі панкейки з фруктами",
      creating: "AI готує...",
      create: "Створити рецепт",
      note:
        "Цей генератор має власні налаштування. Спільний денний ліміт генерацій усе одно діє.",
      loadingTitle: "Створюємо варіанти страви...",
      loadingText: "За мить з’являться 3 різні пропозиції рецепту.",
      fallbackError: "Не вдалося підготувати рецепт.",
      historyPrefix: "Страва:",
    },
    options: {
      diets: {
        "Bez ograniczeń": "Без обмежень",
        Wegetariańska: "Вегетаріанська",
        Wegańska: "Веганська",
        Pescetariańska: "Пескетаріанська",
        Bezglutenowa: "Без глютену",
        "Bez laktozy": "Без лактози",
        Ketogeniczna: "Кетогенна",
        Niskowęglowodanowa: "Низьковуглеводна",
        Śródziemnomorska: "Середземноморська",
        Wysokobiałkowa: "Високобілкова",
      },
    ...
    results: {
      cooking: "AI готує",
      requestedDish: "Рецепт на твоє бажання",
      matched: "Підібрано для тебе",
      demo: "Приклади натхнення",
      preparing: "Готуємо 3 пропозиції",
      variants: "варіанти вибраної страви",
      ideas: "ідеї на сьогодні",
      demoTitle: "Так можуть виглядати результати",
      cookingText:
        "Це може зайняти хвилинку — підбираємо інгредієнти, пропорції, кроки та фото.",
      dishText:
        "Обери найкращий з трьох варіантів. Кожен містить повний список продуктів, інструкцію та харчову цінність.",
      defaultText:
        "Відсоток збігу показує, скільки потрібних продуктів уже є. Відсутні продукти легко перенести до списку покупок.",
      inProgress: "Генерація триває",
      ready: "Результати готові",
      demoMode: "Демо-режим",
      limit: "Ліміт:",
      fullRecipe: "Повний рецепт",
      match: "збігу",
      photo: "Фото:",
      ...
      approx: "прибл.",
      missing: "Бракує",
      haveEverything: "У тебе є все!",
      allOnList: "✓ Усе вже в списку",
      addAllMissing: "Додати всі відсутні",
      substitutions: "Замінники",
      moreInDetails: "більше в деталях рецепту",
      viewRecipe: "Переглянути рецепт",
      noRecipes: "Немає рецептів для вибраних фільтрів",
      noRecipesHint: "Збільш максимальний час або згенеруй нові пропозиції.",
    },
    kitchen: {
      eyebrow: "Твій збережений куточок",
      title: "Моя кухня",
      signedIn:
        "Твої дані збережені в акаунті та доступні після повторного входу.",
      local:
        "Дані зараз зберігаються локально. Увійди, щоб зберегти їх в акаунті та синхронізувати.",
      login: "Увійти або створити акаунт",
      favorites: "Улюблені",
      history: "Історія",
      fullHistory: "Вся історія",
      clear: "Очистити",
      emptyFavorites: "Натисни серце біля рецепту, і він з’явиться тут.",
      generated: "Згенеровано",
      generatedHint: "рецепти з історії",
      savedInspirations: "збережені ідеї",
      recentSearches: "останні пошуки",
      pantry: "Комора",
      pantryHint: "продукти вдома",
      shoppingShort: "Покупки",
      shoppingHint: "продукти до купівлі",
      plan: "План",
      planHint: "страви на тиждень",
      feedback: "Відгуки",
      feedbackHint: "оцінки рецептів",
      dailyLimit: "Сьогоднішній ліміт",
      noLimit: "без ліміту",
      adminAccount: "акаунт адміністратора",
      remainingGenerations: "залишилось генерацій",
      shoppingList: "Список покупок",
      oneProductToBuy: "продукт до купівлі",
      productsToBuy: "продуктів до купівлі",
      expired: "прострочені",
      expiringSoon: "скоро закінчиться термін",
      weeklyPlan: "План тижня",
      plannedMeal: "запланована страва",
      plannedMeals: "запланованих страв",
      lastSaved: "Останній збережений:",
      noHistory:
        "Після генерації рецептів тут з’являться останні пошуки.",
      specificDish: "конкретна страва",
    },
    shopping: {
      ...
      total: "усього",
      copy: "Копіювати",
      copied: "Список покупок скопійовано.",
      copyFailed: "Не вдалося скопіювати список покупок.",
      boughtToPantry: "Куплене до комори",
      removeBought: "Видалити куплене",
      clear: "Очистити",
      placeholder: "Додай продукт, напр. банани",
      add: "Додати",
      pending: "До купівлі",
      bought: "Куплено",
      all: "Усе",
      ...
      toPantry: "До комори",
      remove: "Видалити",
      noBought: "Ще немає куплених продуктів.",
      allBought: "Усе зі списку позначено як куплене.",
      empty:
        "Додай продукт вручну або перенеси відсутні інгредієнти з картки рецепту.",
      alreadyOnList: "Ці продукти вже є у списку покупок.",
      added: "Додано:",
      addedMany: "продуктів додано до списку покупок.",
      uncheck: "Скасувати позначку",
      markBought: "Позначити як куплене",
    },
    recipeModal: {
      ...
      fatShort: "Ж",
      servings: "порції",
      rate: "Оціни цей рецепт",
      servingsLabel: "Порції",
      decreaseServings: "Зменшити кількість порцій",
      increaseServings: "Збільшити кількість порцій",
      cookingMode: "Режим готування",
      markUsed: "Позначити продукти як використані",
      processing: "Обробляю...",
      ...
      publicInfo: "Кожен із посиланням може переглянути цей рецепт.",
      privateInfo: "Рецепт приватний, доки ти ним не поділишся.",
      missingClick: "Відсутні — натисни, щоб додати",
      substitutions: "Замінники інгредієнтів",
      ingredients: "Інгредієнти",
      preparation: "Приготування",
      approx: "прибл.",
    },
    cookingMode: {
      label: "Режим готування:",
      step: "Крок",
      of: "з",
      close: "Закрити режим готування",
      progress: "Прогрес:",
      ingredientsFor: "Інгредієнти на",
      servingOne: "порцію",
      servingFew: "порції",
      servingMany: "порцій",
      scaled: "пропорції перераховано",
      timer: "Кухонний таймер",
      pause: "Пауза",
      start: "Старт",
      doneTitle: "Готово!",
      doneText:
        "Можеш позначити використані продукти як спожиті в коморі або повернутися до рецепту без змін.",
      markUsed: "Позначити інгредієнти як використані",
      closeWithoutChanges: "Закрити без змін",
      showSubstitutions: "Показати замінники інгредієнтів",
      doneStep: "✓ Готово",
      checkStep: "Позначити крок",
...
export const homeCopy = baseHomeCopy;
