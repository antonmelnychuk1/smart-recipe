            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  <span className="rounded-full bg-[#eef2ec] px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-[#025026]">
                ...
                <button
                  ...
                  className="rounded-xl bg-[#025026] px-3 py-2 text-xs font-semibold text-white"
                >
                  {copy.openResults}
                </button>
              </div>
