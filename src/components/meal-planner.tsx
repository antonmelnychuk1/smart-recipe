...
const plannerCopy = {
  ...
  uk: {
    ...
    eyebrow: "Плануй заздалегідь",
    title: "План страв",
    description:
      "Призначай згенеровані або улюблені рецепти на вибраний день і час прийому їжі.",
    ...
    change: "Змінити",
    remove: "Видалити",
    addMissing: "Додати відсутні до покупок",
    close: "Закрити",
    planned: "Заплановано",
    mealsCount: "страв",
    avgCalories: "Сер. калорії",
    kcalMeal: "ккал / страва",
    protein: "Білки",
    total: "усього",
    cost: "Вартість",
    ...
    time: "Час",
    cooking: "готування",
    clearDay: "Очищено день:",
    confirmClear: "Очистити весь план страв на цей тиждень?",
    clearWeekDone: "План тижня очищено.",
    copied: "План тижня скопійовано.",
    copyFailed: "Не вдалося скопіювати план.",
    loading: "Завантажую план...",
    plannedCount: "з 21 страви заплановано",
    local: "план зберігається на цьому пристрої",
    selectRecipe: "Вибери рецепт",
    firstGenerate: "Спочатку згенеруй або збережи улюблений рецепт.",
    planPrefix: "План страв:",
    add: "Додати:",
  },
} as const;
      ...
      <div className={plannerContainerClass}>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="mt-3 flex gap-2 text-xs font-semibold">
                            <button
                              ...
                              className="text-[#025026] hover:underline"
                            >
                              {copy.change}
                            </button>
                            <button
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[#e1ddd4] bg-white p-4">
          <div>
            ...
            {plannerMessage && (
              <p className="mt-1 text-xs font-semibold text-[#025026]">
                {plannerMessage}
              </p>
            )}
          </div>
          {missingIngredients.length > 0 && (
            <button
              ...
              className="rounded-xl bg-[#e8efe9] px-4 py-2.5 text-sm font-semibold text-[#025026]"
            >
