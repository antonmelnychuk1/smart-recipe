...
const savedCopy = {
  ...
  uk: {
    search: "Шукай за назвою, інгредієнтом, описом або відсутнім продуктом",
    allStatuses: "Усі статуси",
    private: "Приватні",
    public: "Публічні",
    allDifficulties: "Будь-яка складність",
    allTypes: "Будь-який тип",
    anyTime: "Будь-який час",
    anyCalories: "Будь-які ккал",
    anyCost: "Будь-яка вартість",
    maxCost: (value: string) => `до ${value}`,
    newest: "Найновіші",
    fastest: "Найшвидші",
    easiest: "Найлегші",
    leastCalories: "Найменше калорій",
    cheapest: "Найдешевші",
    recipes: "рецептів",
    open: "Відкрити",
    ...
    delete: "Видалити",
    approx: "прибл.",
    visibilityFailed: "Не вдалося змінити видимість.",
    isPublic: "Рецепт публічний.",
    isPrivate: "Рецепт приватний.",
    deleteConfirm: "Видалити збережений рецепт",
    deleteFailed: "Не вдалося видалити рецепт.",
    deleted: "Рецепт видалено.",
    copied: "Посилання скопійовано.",
    empty: "У тебе ще немає збережених рецептів",
    noMatches: "Немає відповідних рецептів",
    emptyHint:
      "Згенеруй рецепт і натисни сердечко, щоб він з’явився в бібліотеці.",
    noMatchesHint: "Зміни фільтри або збережи новий рецепт у застосунку.",
    backToGenerator: "Назад до генератора",
    copyPublicAria: "Копіювати публічне посилання на",
    hideAria: "Сховати рецепт",
    shareAria: "Поділитися рецептом",
    deleteAria: "Видалити збережений рецепт",
    tags: {
      "Bez mięsa": "Без м’яса",
      Wegańskie: "Веганське",
      Bezglutenowe: "Без глютену",
      Wysokobiałkowe: "Високобілкове",
    },
  },
} as const;
