...
const adminUsersCopy = {
  ...
  uk: {
    ...
    accountsAndLimits: "Акаунти та ліміти",
    allUsers: "Усі користувачі",
    description:
      "Шукай, фільтруй і керуй акаунтами без прокручування широкої таблиці.",
    accounts: "акаунтів",
    admins: "Адміни",
    bannedUsers: "Заблоковані",
    atLimit: "На ліміті",
    unverified: "Непідтверджені",
    searchPlaceholder: "Шукай за ім’ям або e-mail",
    allRoles: "Будь-яка роль",
    allStatuses: "Будь-який статус",
    activeUsers: "Активні",
    allVerification: "Будь-яка верифікація",
    verified: "Підтверджені",
    allLimits: "Будь-який ліміт",
    availableLimit: "З доступним лімітом",
    newest: "Найновіші",
    lastActivity: "Остання активність",
    mostGenerations: "Найбільше генерацій",
    mostFavorites: "Найбільше улюблених",
    mostHistory: "Найбільше історії",
    reset: "Скинути",
    unnamed: "Без назви",
    active: "активний",
    banned: "заблокований",
    emailUnverified: "e-mail не підтверджено",
    noLimit: "без ліміту",
    today: "Сьогодні",
    total: "Усього",
    favorites: "Улюблені",
    ...
    noUsers: "Немає відповідних користувачів",
    noUsersHint: "Зміни фільтри або очисти пошук.",
