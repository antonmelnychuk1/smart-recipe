...
export type SearchHistoryWhereInput = {
  ...
  recipes?: Prisma.JsonFilter<"SearchHistory">
...
export type SearchHistoryScalarWhereWithAggregatesInput = {
  ...
  recipes?: Prisma.JsonWithAggregatesFilter<"SearchHistory">
...
export type SearchHistoryCreateInput = {
  ...
  diet: string
  maxTime: number
  recipes: Prisma.JsonNullValueInput | runtime.InputJsonValue
...
export type SearchHistoryCreateingredientsInput = {
  set: string[]
}

export type SearchHistoryUpdateingredientsInput = {
  set?: string[]
  push?: string | string[]
}
...
export interface SearchHistoryFieldRefs {
  ...
  readonly recipes: Prisma.FieldRef<"SearchHistory", 'Json'>
